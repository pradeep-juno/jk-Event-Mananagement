...
class HrStaffCreationsPage extends StatefulWidget {
  const HrStaffCreationsPage({super.key});

  @override
  State<HrStaffCreationsPage> createState() => _HrStaffCreationsPageState();
}
...
class _HrStaffCreationsPageState extends State<HrStaffCreationsPage> {
  ...
  void _showStaffDialog(BuildContext context, {required String id}) {
    Get.to(() => HrAddUpdateStaffPage(), arguments: id);
  }
